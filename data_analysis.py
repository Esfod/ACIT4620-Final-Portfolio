...
def evaluate_dog_conditions(dog_data_list, system, is_dog_ok, output_var="is_dog_ok"):
    ...
    for i in dog_data_list:
        ...
        try:
            ...
            # Get the highest two memberships
            ...
            # Print the result
            print(f"Time: {i.time} | Output value for {output_var}: {output_value:.2f} -> Condition: {condition}")
...
def plot_dog_condition(results):
    ...
    condition_mapping = {
        "perfect": {"value": 4, "color": "#a8c9ca"},  # Opal
        "normal": {"value": 3, "color": "#a6d301"},   # Pistachio
        "need help": {"value": 2, "color": "#d37401"}, # Orange
        "urgent": {"value": 1, "color": "#a90120"},    # Dark Red
        "unknown": {"value": 0, "color": "gray"}      # Default for missing hours
    }
    ...
    bar_colors = [condition_mapping[cond]["color"] for cond in full_day_conditions]
